...
function App() {
  return (
    <>
        ...
        {/* <!-- Navbar --> */}
        <nav class="navbar">
            <img src="images/portfolio-logo.png" alt="CR Logo"></img>
        </nav>
    ...
    <section class="projects">
        ...
        <div>
            <div class="project-box">
                <a href="https://crayburn18.github.io/Calendar-Homework/" target="blank"><img src="images/iconfinder_calendar-book-date-monthly_2203551.png" alt=""></img></a>
                <h2>Day Planner</h2>
            ...
            <div class="project-box">
                <a href="https://vast-bayou-08421.herokuapp.com/login" target="blank"><img src="images/iconfinder_house-home-main-menu-start-building_3643769.png" alt=""></img></a>
                <h2>House Hunter</h2>
            ...
            <div class="project-box">
                <a href="https://crayburn18.github.io/PasswordGenerator/" target="blank"><img src="images/iconfinder_icons_password_1564520.png" alt=""></img></a>
            ...
            <div class="project-box">
                <a href="https://dazacher.github.io/Trivia-With-Friends/" target="blank"><img src="images/iconfinder_multimedia-19_809511.png" alt=""></img></a>
